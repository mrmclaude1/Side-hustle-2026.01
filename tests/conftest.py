...
os.environ.setdefault("MARKETSONAR_DB", ":memory:")
os.environ.setdefault("MARKETSONAR_DEMO", "1")
os.environ.setdefault("MARKETSONAR_DISABLE_RATELIMIT", "1")
os.environ.setdefault("MARKETSONAR_ADMIN_TOKEN", "test-admin")
